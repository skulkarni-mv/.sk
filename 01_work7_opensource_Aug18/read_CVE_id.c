...
void main(int argc, char **argv)
{
	...
	strcat(buffer, " /home/shubham/.sk/work7_opensource/");
	...
	FILE *fp=fopen("/home/shubham/.sk/work7_opensource/bugs-2022-08-18.csv", "r");
	...
	if(fp)
	{
		...
		FILE *fw=fopen("/home/shubham/.sk/work7_opensource/CVE_nums_extracted.txt", "w");
...
void create_python_code(void)
{
	...
	FILE *fpy=fopen("/home/shubham/.sk/work7_opensource/code_web.py", "w");
	...
	FILE *fp=fopen("/home/shubham/.sk/work7_opensource/CVE_nums_extracted.txt", "r");
	...
	while( fscanf(fp, "%s", buf_fscanf) != EOF)
	{
		...
		if(i != 1)
		{
			strcat(buffer, "https://git.openembedded.org/openembedded-core-contrib/log/?h=stable%2Fdunfell-nut&qt=grep&q=");
...
void open_tabs_browser(int i)
{
	...
	//system("python /home/shubham/.sk/work7_opensource/code_web.py")
	...
	printf("\t python /home/shubham/.sk/work7_opensource/code_web.py \n\n");


	system("xclip -selection primary /home/shubham/.sk/work7_opensource/.copy_cmd");
	//system("xclip -selection clipboard /home/shubham/.sk/work7_opensource/.copy_cmd");
	
	fflush(stdout);

	sleep(3);

	system("gedit /home/shubham/.sk/work7_opensource/code_web.py");
