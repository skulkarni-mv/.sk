...
int main(int argc, char *argv[])
{
	...
	int return_val=0;
	char redir_buffer[500]={0};

	if(argc != 2)
	{
		printf("\n No command passed. Usage: tskr <cmd_to_calc_time_of_execution>\n\n");
		return -1;
	}

	system("pwd > /home/qauser/.sk/info_build.txt");		// Newly written Everytime

	FILE* fp=fopen("/home/qauser/.sk/info_build.txt","r+");
	...
	fseek(fp, 0, SEEK_SET);
	fgets(buf_cmd_op, 490, fp);			strcpy(fp_cmd_op, buf_cmd_op);		/// /home/qauser/ cmd: ls -> READS till '\n'
...
///	printf("\n%s\n", fp_cmd_op);				/// Print Data from file, Comment the String Printing
	...
	fp=fopen("/home/qauser/.sk/info_build.txt","w");	/// Reopen the file in Write Mode to erase previous contents and load New Data
	...
	printf("\n");   fflush(stdout);
	system("cat /home/qauser/.sk/info_build.txt");		// Print the contents of the File
...
//*****************************************************************************************************************
	...
	printf("\n");
	system("cat /home/qauser/.sk/info_build.txt");
